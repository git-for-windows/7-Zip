    ...
    /* lpCmdLine */,int /* nCmdShow */)
{
  ...
  if (!config.IsEmpty())
  {
    ...
    extractDialogText = GetTextConfigValue(pairs, L"ExtractDialogText");
	UString extractPathText = GetTextConfigValue(pairs, L"ExtractPathText");
	UString cancelPrompt = GetTextConfigValue(pairs, L"CancelPrompt");
